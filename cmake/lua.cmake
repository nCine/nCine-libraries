...
if(MSVC)
	ExternalProject_Add(project_${TARGET_LUA}
		...
		BUILD_IN_SOURCE 0
		INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/${CMAKE_BUILD_TYPE}/lua55.dll ${BINDIR}/
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/${CMAKE_BUILD_TYPE}/lua55.lib ${LIBDIR}/
...
elseif(APPLE)
	...
	set(DYLIBNAME_LUA liblua5.5.dylib)
...
elseif(MINGW)
	ExternalProject_Add(project_${TARGET_LUA}
		...
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 0
		INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/liblua55.dll ${DESTINATION_PATH}/bin/liblua55.dll
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/liblua55.dll.a ${DESTINATION_PATH}/lib/liblua55.dll.a
	...
	ExternalProject_Add(project_${TARGET_LUA}
		...
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 0
		INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/liblua5.5.so ${DESTINATION_PATH}/lib/liblua5.5.so
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROJECT_BUILD_LUA}/liblua.a ${DESTINATION_PATH}/lib/liblua.a
