...
elseif(NOT EMSCRIPTEN)
	ExternalProject_Add(project_${TARGET_GLEW}
		...
		URL_MD5 ${URL_MD5_GLEW}
		CONFIGURE_COMMAND ${CMAKE_COMMAND} -E touch CMakeLists.txt
			COMMAND ${CMAKE_COMMAND} build/cmake -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${COMMON_CMAKE_ARGS_GLEW} -DGLEW_EGL=ON -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH} -G ${CMAKE_GENERATOR}
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 1
