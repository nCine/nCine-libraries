...
elseif(APPLE)
	...
	if(CMAKE_BUILD_TYPE STREQUAL "Debug")
		set(DYLIBNAME_PNG libpng16d.16.50.0.dylib)
	else()
		set(DYLIBNAME_PNG libpng16.16.50.0.dylib)
	endif()
...
elseif(NOT EMSCRIPTEN)
	ExternalProject_Add(project_${TARGET_PNG}
		...
		URL ${URL_PNG}
		URL_MD5 ${URL_MD5_PNG}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${COMMON_CMAKE_RPATH_ARGS} -DZLIB_LIBRARIES=${BUILDDIR_ZLIB}/${LIBNAME_ZLIB} -DZLIB_INCLUDE_DIRS=${BUILDDIR_ZLIB} ${COMMON_CMAKE_ARGS_PNG} -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 0
