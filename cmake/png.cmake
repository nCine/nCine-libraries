...
elseif(APPLE)
	...
	if(CMAKE_BUILD_TYPE STREQUAL "Debug")
		set(DYLIBNAME_PNG libpng16d.16.53.0.dylib)
	else()
		set(DYLIBNAME_PNG libpng16.16.53.0.dylib)
	endif()
...
elseif(NOT EMSCRIPTEN)
	ExternalProject_Add(project_${TARGET_PNG}
		...
		URL ${URL_PNG}
		URL_MD5 ${URL_MD5_PNG}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${COMMON_CMAKE_RPATH_ARGS} -DCMAKE_PREFIX_PATH=${DESTINATION_PATH} ${COMMON_CMAKE_ARGS_PNG} -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 0
