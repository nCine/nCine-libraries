...
if(MSVC)
	...
	ExternalProject_Add(project_${TARGET_PNG}
		...
		URL ${URL_PNG}
		URL_MD5 ${URL_MD5_PNG}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CONFIGURATION} -DZLIB_LIBRARY=${BUILDDIR_ZLIB}/${LIBFILE_ZLIB_LIBDYN} -DZLIB_INCLUDE_DIR=${BUILDDIR_ZLIB} ${COMMON_CMAKE_ARGS_PNG} -DSKIP_INSTALL_ALL=1
		BUILD_IN_SOURCE 0
...
elseif(APPLE)
	...
	set(DYLIBNAME_PNG libpng16.16.30.0.dylib)
	...
	ExternalProject_Add(project_${TARGET_PNG}
		...
		URL ${URL_PNG}
		URL_MD5 ${URL_MD5_PNG}
		CMAKE_ARGS -DZLIB_LIBRARY=${BUILDDIR_ZLIB}/${DYLIBNAME_ZLIB} -DZLIB_INCLUDE_DIR=${BUILDDIR_ZLIB} ${COMMON_CMAKE_ARGS_PNG}
	...
	ExternalProject_Add(project_${TARGET_PNG}
		...
		URL ${URL_PNG}
		URL_MD5 ${URL_MD5_PNG}
		CMAKE_ARGS -DZLIB_LIBRARY=${ZLIB_LIBRARY} -DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIR} ${COMMON_CMAKE_ARGS_PNG} -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_COMMAND ${PARALLEL_MAKE}
		BUILD_IN_SOURCE 0
