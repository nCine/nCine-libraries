...
if(MSVC)
	...
	if(MSVC_IDE)
		...
		set(LIBFILE_ZLIB_LIBDYN ${CONFIGURATION}/${LIBNAME_ZLIB_DLL}.lib)
		set(LIBFILE_ZLIB_LIB ${CONFIGURATION}/${LIBNAME_ZLIB_LIB}.lib)
	else()
		set(LIBFILE_ZLIB_DLL ${LIBNAME_ZLIB_DLL}.dll)
		set(LIBFILE_ZLIB_LIBDYN ${LIBNAME_ZLIB_DLL}.lib)
...
elseif(APPLE)
	...
	ExternalProject_Add(project_${TARGET_ZLIB}
		URL ${URL_ZLIB}
		URL_MD5 ${URL_MD5_ZLIB}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CONFIGURATION} -DCMAKE_MACOSX_RPATH=ON
	...
	ExternalProject_Add(project_${TARGET_ZLIB}
		URL ${URL_ZLIB}
		URL_MD5 ${URL_MD5_ZLIB}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CONFIGURATION} -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_COMMAND ${PARALLEL_MAKE}
		BUILD_IN_SOURCE 0
