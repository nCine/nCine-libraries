...
set(COMMON_CMAKE_ARGS_SDL2 -DSDL_ATOMIC=OFF -DSDL_AUDIO=OFF -DSDL_CPUINFO=OFF -DSDL_DIRECTX=OFF -DSDL_DUMMYVIDEO=OFF -DSDL_FILE=OFF -DSDL_FILESYSTEM=OFF -DSDL_LOCALE=OFF -DSDL_MISC=OF -DSDL_OFFSCREEN=OFF -DSDL_POWER=OFF -DSDL_RENDER=OFF -DSDL_SENSOR=OFF -DSDL_TEST=OFF)
...
if(MSVC)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		...
		CMAKE_ARGS -DSDL_STATIC=OFF ${COMMON_CMAKE_ARGS_SDL2}
...
elseif(APPLE)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		URL ${URL_SDL2}
		URL_MD5 ${URL_MD5_SDL2}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${COMMON_CMAKE_ARGS_SDL2}
...
elseif(NOT EMSCRIPTEN)
	ExternalProject_Add(project_${TARGET_SDL2}
		URL ${URL_SDL2}
		URL_MD5 ${URL_MD5_SDL2}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} ${COMMON_CMAKE_ARGS_SDL2} -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
		BUILD_IN_SOURCE 0
