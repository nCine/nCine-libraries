...
elseif(APPLE)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		...
		INSTALL_COMMAND ${CMAKE_COMMAND} -E make_directory ${FRAMEWORK_DIR_SDL2}/Versions/A
			...
			COMMAND ${CMAKE_COMMAND} -E copy_directory ${EP_BASE}/Source/project_${TARGET_SDL2}/include ${FRAMEWORK_DIR_SDL2}/Versions/A/Headers/SDL2
			# Copy SDL.h to the Headers directory for FindSDL2.cmake to work
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${EP_BASE}/Source/project_${TARGET_SDL2}/include/SDL.h ${FRAMEWORK_DIR_SDL2}/Versions/A/Headers
			COMMAND ${CMAKE_COMMAND} -E copy_if_different include/SDL_config.h ${FRAMEWORK_DIR_SDL2}/Versions/A/Headers/SDL2
