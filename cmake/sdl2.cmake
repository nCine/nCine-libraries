...
set(URL_SDL2 https://www.libsdl.org/release/SDL2-2.0.5.tar.gz)
set(URL_MD5_SDL2 d4055424d556b4a908aa76fad63abd3c)
...
if(MSVC)
	if(MSVC_IDE)
		...
		set(LIBFILE_SDL2_LIBDYN ${CONFIGURATION}/${LIBNAME_SDL2}.lib)
		set(LIBFILE_SDL2MAIN ${CONFIGURATION}/${LIBNAME_SDL2MAIN}.lib)
	else()
		set(LIBFILE_SDL2_DLL ${LIBNAME_SDL2}.dll)
		set(LIBFILE_SDL2_LIBDYN ${LIBNAME_SDL2}.lib)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		...
		INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${LIBFILE_SDL2_DLL} ${BINDIR}/
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${LIBFILE_SDL2_LIBDYN} ${LIBDIR}/
...
elseif(APPLE)
	...
	set(DYLIBNAME_SDL2 libSDL2-2.0.0.4.1.dylib)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		URL ${URL_SDL2}
		URL_MD5 ${URL_MD5_SDL2}
		CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${DESTINATION_PATH}
		BUILD_IN_SOURCE 0
